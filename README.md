...
Specializing in high-availability enterprise infrastructure and production-grade GenAI workflows. 

🔗 [pavelkerbel.com](https://pavelkerbel.com) | 💼 [LinkedIn](https://www.linkedin.com/in/kerbelp/) | 🐦 [X](https://x.com/kerbelp)

---

### 🛠️ Core Focus
* **Systems Engineering:** 14+ years designing cost-optimized, fault-tolerant distributed cloud architectures (Ex-Meta, Ex-Microsoft, Palo Alto Networks).
...
* **[z-mail-agent](https://github.com/kerbelp/z-mail-agent):** An extensible, configuration-driven email automation framework built using LangGraph.
